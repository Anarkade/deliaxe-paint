...
const translations: Record<Language, Translation> = {
  ...
  'ca': { 
    ...
    loadImageDesc: 'Puja una imatge des del teu dispositiu, fes una foto amb la càmera o enganxa des del portapapers',
  ...
  'zh-CN': { 
    ...
    loadImageDesc: '从设备上传图片，用摄像头拍照或从剪贴板粘贴',
  ...
  'zh-TW': { 
    ...
    loadImageDesc: '從裝置上傳圖片，用攝影機拍照或從剪貼簿貼上',
  ...
  'de': { 
    ...
    loadImageDesc: 'Bild von Ihrem Gerät hochladen, mit Kamera fotografieren oder aus Zwischenablage einfügen',
  ...
  'fr': { 
    ...
    loadImageDesc: 'Téléchargez une image depuis votre appareil, prenez une photo avec la caméra ou collez depuis le presse-papiers',
