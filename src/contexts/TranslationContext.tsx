...
interface Translation {
  ...
  dragAndClickInstructions: string;
...
const baseTranslation: Translation = {
  ...
  dragAndClickInstructions: 'Drag to reorder • Click colors to change them',
...
const translations: Record<Language, Translation> = {
  ...
  'es-ES': { 
    ...
    dragAndClickInstructions: 'Arrastra para reordenar • Haz clic en los colores para cambiarlos',
  ...
  'es-LA': { 
    ...
    dragAndClickInstructions: 'Arrastrá para reordenar • Hacé clic en los colores para cambiarlos',
  ...
  'ca': { 
    ...
    dragAndClickInstructions: 'Arrossega per reordenar • Fes clic als colors per canviar-los',
  ...
  'fr': { 
    ...
    dragAndClickInstructions: 'Glisser pour réorganiser • Cliquez sur les couleurs pour les modifier',
  ...
  'de': { 
    ...
    dragAndClickInstructions: 'Ziehen zum Neuordnen • Auf Farben klicken zum Ändern',
  ...
  'it': { 
    ...
    dragAndClickInstructions: 'Trascina per riordinare • Clicca sui colori per modificarli',
  ...
  'pt-PT': { 
    ...
    dragAndClickInstructions: 'Arrastar para reordenar • Clique nas cores para as alterar',
  ...
  'pt-BR': { 
    ...
    dragAndClickInstructions: 'Arrastar para reordenar • Clique nas cores para alterá-las',
  ...
  'ru': { 
    ...
    dragAndClickInstructions: 'Перетащите для изменения порядка • Нажмите на цвета для их изменения',
  ...
  'zh-CN': { 
    ...
    dragAndClickInstructions: '拖拽重新排序 • 点击颜色以更改',
  ...
  'zh-TW': { 
    ...
    dragAndClickInstructions: '拖拉重新排序 • 點擊顏色以更改',
  ...
  'ja': { 
    ...
    dragAndClickInstructions: 'ドラッグして並び替え • 色をクリックして変更',
  ...
  'pl': { 
    ...
    dragAndClickInstructions: 'Przeciągnij aby zmienić kolejność • Kliknij kolory aby je zmienić',
  ...
  'tr': { 
    ...
    dragAndClickInstructions: 'Yeniden sıralamak için sürükle • Değiştirmek için renklere tıkla',
  ...
  'eu': { 
    ...
    dragAndClickInstructions: 'Arrastatu berrordenatzeko • Klik egin koloreetan aldatzeko',
  ...
  'oc': { 
    ...
    dragAndClickInstructions: 'Lisar tà reordenar • Clicar sus es colors tà cambiar-los',
