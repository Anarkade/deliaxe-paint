...
const baseTranslation: Translation = {
  ...
  loadImageDesc: 'Import an image from your device, take a photo with camera, or paste from clipboard [I]',
  changePaletteDesc: 'Choose a retro color palette to transform your image [P]',
  changeResolutionDesc: 'Adjust image dimensions and scaling for retro systems [R]',
  changeGridsDesc: 'Add visual grids and overlays to your image [G]',
  exportImageDesc: 'Save your retro-styled image with custom settings [E]',
...
const translations: Record<Language, Translation> = {
  ...
  'es-ES': { 
    ...
    loadImageDesc: 'Importa una imagen desde tu dispositivo, toma una foto con la cámara o pega desde el portapapeles [I]',
    changePaletteDesc: 'Elige una paleta de colores retro para transformar tu imagen [P]',
    changeResolutionDesc: 'Ajusta las dimensiones de la imagen y el escalado para sistemas retro [R]',
    changeGridsDesc: 'Añade cuadrículas visuales y superposiciones a tu imagen [G]',
    exportImageDesc: 'Guarda tu imagen con estilo retro con configuraciones personalizadas [E]',
  ...
  'th': {
    ...
    loadImageDesc: 'นำเข้ารูปจากอุปกรณ์ ถ่ายด้วยกล้อง หรือวางจากคลิปบอร์ด [I]',
    changePaletteDesc: 'เลือกจานสีสไตล์เรโทรเพื่อเปลี่ยนรูป [P]',
    changeResolutionDesc: 'ปรับขนาดรูปและการปรับขนาดสำหรับระบบเรโทร [R]',
    changeGridsDesc: 'เพิ่มเส้นตารางและเลเยอร์ให้รูป [G]',
    exportImageDesc: 'บันทึกรูปสไตล์เรโทรด้วยการตั้งค่าที่กำหนดเอง [E]',
  ...
  'ko': {
    ...
    loadImageDesc: '장치에서 이미지 가져오기, 카메라로 사진 촬영 또는 클립보드에서 붙여넣기 [I]',
    changePaletteDesc: '레트로 색상 팔레트를 선택하여 이미지 변환 [P]',
    changeResolutionDesc: '레트로 시스템용 이미지 크기 및 스케일링 조정 [R]',
    changeGridsDesc: '이미지에 시각적 격자 및 오버레이 추가 [G]',
    exportImageDesc: '사용자 정의 설정으로 레트로 스타일 이미지 저장 [E]',
  ...
  'cs': {
    ...
    loadImageDesc: 'Importujte obrázek ze zařízení, vyfotografujte kamerou nebo vložte ze schránky [I]',
    changePaletteDesc: 'Vyberte retro barevnou paletu pro transformaci obrázku [P]',
    changeResolutionDesc: 'Upravte rozměry obrázku a škálování pro retro systémy [R]',
    changeGridsDesc: 'Přidejte vizuální mřížky a překryvy k obrázku [G]',
    exportImageDesc: 'Uložte obrázek v retro stylu s vlastním nastavením [E]',
  ...
  'ca': { 
    ...
    loadImageDesc: 'Importa una imatge des del teu dispositiu, fes una foto amb la càmera o enganxa des del portapapers [I]',
    changePaletteDesc: 'Tria una paleta de colors retro per transformar la teva imatge [P]',
    changeResolutionDesc: 'Ajusta les dimensions de la imatge i l\'escalat per sistemes retro [R]',
    changeGridsDesc: 'Afegeix graelles visuals i superposicions a la teva imatge [G]',
    exportImageDesc: 'Desa la teva imatge amb estil retro amb configuracions personalitzades [E]',
  ...
  'zh-CN': { 
    ...
    loadImageDesc: '从设备导入图片，用摄像头拍照或从剪贴板粘贴 [I]',
    changePaletteDesc: '选择复古调色板来变换你的图片 [P]',
    changeResolutionDesc: '为复古系统调整图片尺寸和缩放 [R]',
    changeGridsDesc: '为图片添加视觉网格和覆盖层 [G]',
    exportImageDesc: '使用自定义设置保存复古风格图片 [E]',
  ...
  'zh-TW': { 
    ...
    loadImageDesc: '從裝置匯入圖片，用攝影機拍照或從剪貼簿貼上 [I]',
    changePaletteDesc: '選擇復古調色板來變換你的圖片 [P]',
    changeResolutionDesc: '為復古系統調整圖片尺寸和縮放 [R]',
    changeGridsDesc: '為圖片添加視覺網格和覆蓋層 [G]',
    exportImageDesc: '使用自訂設定儲存復古風格圖片 [E]',
    zoomedResolution: '已縮放',
    colorsPalette: '調色板',
    paletteWithCount: '{count}色調色板',
    processImageFirst: '請先處理圖片以啟用匯出選項',
    language: '語言',
    changeLanguage: '變更語言 [L]',
    languageNames: {
      'en': 'English (英語)',
      'es-ES': 'Español (西班牙語)',
      'es-LA': 'Español (拉美西語)',
  ...
  'ja': { 
    ...
    loadImageDesc: 'デバイスから画像をインポート、カメラで撮影、またはクリップボードから貼り付け [I]',
    changePaletteDesc: 'レトロカラーパレットを選択して画像を変換 [P]',
    changeResolutionDesc: 'レトロシステム用に画像の寸法とスケーリングを調整 [R]',
    changeGridsDesc: '画像にビジュアルグリッドとオーバーレイを追加 [G]',
    exportImageDesc: 'カスタム設定でレトロスタイル画像を保存 [E]',
  ...
  'it': { 
    ...
    loadImageDesc: 'Importa un\'immagine dal tuo dispositivo, scatta una foto con la fotocamera o incolla dagli appunti [I]',
    changePaletteDesc: 'Scegli una palette di colori retro per trasformare la tua immagine [P]',
    changeResolutionDesc: 'Regola le dimensioni dell\'immagine e il ridimensionamento per sistemi retro [R]',
    changeGridsDesc: 'Aggiungi griglie visive e sovrapposizioni alla tua immagine [G]',
    exportImageDesc: 'Salva la tua immagine in stile retro con impostazioni personalizzate [E]',
  ...
  'de': { 
    ...
    loadImageDesc: 'Bild von Ihrem Gerät importieren, mit Kamera fotografieren oder aus Zwischenablage einfügen [I]',
    changePaletteDesc: 'Wählen Sie eine Retro-Farbpalette zur Bildtransformation [P]',
    changeResolutionDesc: 'Bildabmessungen und Skalierung für Retro-Systeme anpassen [R]',
    changeGridsDesc: 'Visuelle Raster und Überlagerungen zu Ihrem Bild hinzufügen [G]',
    exportImageDesc: 'Retro-Stil-Bild mit benutzerdefinierten Einstellungen speichern [E]',
  ...
  'fr': { 
    ...
    loadImageDesc: 'Importez une image depuis votre appareil, prenez une photo avec la caméra ou collez depuis le presse-papiers [I]',
    changePaletteDesc: 'Choisissez une palette de couleurs rétro pour transformer votre image [P]',
    changeResolutionDesc: 'Ajustez les dimensions de l\'image et la mise à l\'échelle pour les systèmes rétro [R]',
    changeGridsDesc: 'Ajoutez des grilles visuelles et des superpositions à votre image [G]',
    exportImageDesc: 'Sauvegardez votre image de style rétro avec des paramètres personnalisés [E]',
