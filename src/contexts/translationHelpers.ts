...
import translationsChangeImageResolutionCsv from '../locales/translationsChangeImageResolution.csv?raw'
...
const csvData = mergeParsedCsvObjects([
  ...
  parseTranslationsCsv(translationsChangeImageResolutionCsv),
